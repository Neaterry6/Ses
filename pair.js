...
const {
    ...
    Browsers
} = require("@whiskeysockets/baileys"); // ✅ Changed Baileys version
...
`;
                    ...
                    await Pair_Code_By_Gifted_Tech.sendMessage(Pair_Code_By_Gifted_Tech.user.id, { text: ULTRA_TITAN_MD_TEXT }, { quoted: session });
